...
let Accordion = class {
  constructor(hostRef) {
    ...
    this.setAria = (expanded = false) => {
      ...
      const root = (0,_helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_4__.g)(ionItem);
    ...
    this.expandAccordion = (initialUpdate = false) => {
      ...
      if (this.shouldAnimate()) {
        (0,_helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => {
          this.state = 8
          /* Expanding */
          ;
          this.currentRaf = (0,_helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_4__.r)( /*#__PURE__*/(0,_Volumes_Development_DTD_Axion_temp_captest_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            const contentHeight = contentElWrapper.offsetHeight;
            const waitForTransition = (0,_helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_4__.t)(contentEl, 2000);
    ...
    this.collapseAccordion = (initialUpdate = false) => {
      ...
      if (this.shouldAnimate()) {
        this.currentRaf = (0,_helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_4__.r)( /*#__PURE__*/(0,_Volumes_Development_DTD_Axion_temp_captest_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
          ...
          contentEl.style.setProperty('max-height', `${contentHeight}px`);
          (0,_helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_4__.r)( /*#__PURE__*/(0,_Volumes_Development_DTD_Axion_temp_captest_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            const waitForTransition = (0,_helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_4__.t)(contentEl, 2000);
            _this.state = 2
            /* Collapsing */
            ;
    ...
    this.updateState = /*#__PURE__*/(0,_Volumes_Development_DTD_Axion_temp_captest_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (initialUpdate = false) {
  ...
  connectedCallback() {
    ...
    if (accordionGroupEl) {
      ...
      (0,_helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_4__.a)(accordionGroupEl, 'ionChange', this.updateListener);
    }
  }
  ...
  disconnectedCallback() {
    ...
    if (accordionGroupEl) {
      (0,_helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_4__.b)(accordionGroupEl, 'ionChange', this.updateListener);
    }
  }
