...
declare type ChildCustomElementDefinition = {
  tagName: string;
  customElement: any;
};
...
export declare const prepareOverlay: <T extends HTMLIonOverlayElement>(el: T, options?: OverlayListenerOptions) => void;
export declare const createOverlay: <T extends HTMLIonOverlayElement>(tagName: string, opts: object | undefined, customElement?: any, childrenCustomElements?: ChildCustomElementDefinition[] | undefined) => Promise<T>;
