...
const index$2 = require('./index-365d7fb3.js');
const theme = require('./theme-a4c4a7eb.js');
const animation = require('./animation-abbf2fb2.js');
const backdrop = require('./backdrop-53e642b6.js');
...
const index$3 = require('./index-f14ae831.js');
const cubicBezier = require('./cubic-bezier-1060abff.js');
const rippleEffect = require('./ripple-effect-0d5115f5.js');
const spinner = require('./spinner-1cb8b477.js');
...
let ActionSheet = class {
  ...
  render() {
    ...
    return (index$1.h(index$1.Host, Object.assign({ role: "dialog", "aria-modal": "true", tabindex: "-1" }, htmlAttributes, { style: {
      ...
      index$1.h("div", { class: "action-sheet-group action-sheet-group-cancel" }, index$1.h("button", { type: "button", class: buttonClass$3(cancelButton), onClick: () => this.buttonClick(cancelButton) }, index$1.h("span", { class: "action-sheet-button-inner" }, cancelButton.icon &&
...
let Alert = class {
  ...
  renderAlertButtons() {
    ...
    return (index$1.h("div", { class: alertButtonGroupClass }, buttons.map(button => index$1.h("button", { type: "button", id: button.id, class: buttonClass$2(button), tabIndex: 0, onClick: () => this.buttonClick(button) }, index$1.h("span", { class: "alert-button-inner" }, button.text), mode === 'md' && index$1.h("ion-ripple-effect", null)))));
  }
  render() {
...
let Loading = class {
  constructor(hostRef) {
    index$1.registerInstance(this, hostRef);
    this.didPresent = index$1.createEvent(this, "ionLoadingDidPresent", 7);
    this.willPresent = index$1.createEvent(this, "ionLoadingWillPresent", 7);
    this.willDismiss = index$1.createEvent(this, "ionLoadingWillDismiss", 7);
    this.didDismiss = index$1.createEvent(this, "ionLoadingDidDismiss", 7);
    this.presented = false;
    /**
     * If `true`, the keyboard will be automatically dismissed when the overlay is presented.
     */
  ...
  render() {
    ...
    const mode = ionicGlobal.getIonMode(this);
    return (index$1.h(index$1.Host, Object.assign({ tabindex: "-1" }, htmlAttributes, { style: {
        zIndex: `${40000 + this.overlayIndex}`
      }, onIonBackdropTap: this.onBackdropTap, class: Object.assign(Object.assign({}, theme.getClassMap(this.cssClass)), { [mode]: true, 'overlay-hidden': true, 'loading-translucent': this.translucent }) }), index$1.h("ion-backdrop", { visible: this.showBackdrop, tappable: this.backdropDismiss }), index$1.h("div", { tabindex: "0" }), index$1.h("div", { class: "loading-wrapper ion-overlay-wrapper", role: "dialog" }, spinner && (index$1.h("div", { class: "loading-spinner" }, index$1.h("ion-spinner", { name: spinner, "aria-hidden": "true" }))), message && index$1.h("div", { class: "loading-content", innerHTML: index$2.sanitizeDOMString(message) })), index$1.h("div", { tabindex: "0" })));
  }
  get el() { return index$1.getElement(this); }
};
Loading.style = {
...
let Modal = class {
  ...
  initSwipeToClose() {
    ...
    const animationBuilder = this.leaveAnimation || ionicGlobal.config.get('modalLeave', iosLeaveAnimation$3);
  ...
  initSheetGesture() {
    ...
    const animationBuilder = this.enterAnimation || ionicGlobal.config.get('modalEnter', iosEnterAnimation$3);
...
let PickerColumnCmp = class {
  ...
  render() {
    ...
    return (index$1.h(index$1.Host, { class: {
      ...
      } }, col.prefix && (index$1.h("div", { class: "picker-prefix", style: { width: col.prefixWidth } }, col.prefix)), index$1.h("div", { class: "picker-opts", style: { maxWidth: col.optionsWidth }, ref: el => this.optsEl = el }, col.options.map((o, index) => index$1.h(Button, { type: "button", class: { 'picker-opt': true, 'picker-opt-disabled': !!o.disabled }, "opt-index": index }, o.text))), col.suffix && (index$1.h("div", { class: "picker-suffix", style: { width: col.suffixWidth } }, col.suffix))));
  }
  get el() { return index$1.getElement(this); }
  static get watchers() { return {
    "col": ["colChanged"]
...
let Toast = class {
  ...
  renderButtons(buttons, side) {
    ...
    return (index$1.h("div", { class: buttonGroupsClasses }, buttons.map(b => index$1.h("button", { type: "button", class: buttonClass(b), tabIndex: 0, onClick: () => this.buttonClick(b), part: "button" }, index$1.h("div", { class: "toast-button-inner" }, b.icon &&
      index$1.h("ion-icon", { icon: b.icon, slot: b.text === undefined ? 'icon-only' : undefined, class: "toast-button-icon" }), b.text), mode === 'md' && index$1.h("ion-ripple-effect", { type: b.icon !== undefined && b.text === undefined ? 'unbounded' : 'bounded' })))));
  }
  render() {
    const allButtons = this.getButtons();
    ...
    return (index$1.h(index$1.Host, Object.assign({ role: role, tabindex: "-1" }, this.htmlAttributes, { style: {
        zIndex: `${60000 + this.overlayIndex}`,
      }, class: theme.createColorClasses(this.color, Object.assign(Object.assign({ [mode]: true }, theme.getClassMap(this.cssClass)), { 'overlay-hidden': true, 'toast-translucent': this.translucent })), onIonToastWillDismiss: this.dispatchCancelHandler }), index$1.h("div", { class: wrapperClass }, index$1.h("div", { class: "toast-container", part: "container" }, this.renderButtons(startButtons, 'start'), this.icon !== undefined &&
      index$1.h("ion-icon", { class: "toast-icon", part: "icon", icon: this.icon, lazy: false, "aria-hidden": "true" }), index$1.h("div", { class: "toast-content" }, this.header !== undefined &&
      index$1.h("div", { class: "toast-header", part: "header" }, this.header), this.message !== undefined &&
      index$1.h("div", { class: "toast-message", part: "message", innerHTML: index$2.sanitizeDOMString(this.message) })), this.renderButtons(endButtons, 'end')))));
  }
  get el() { return index$1.getElement(this); }
};
...
const alertController = /*@__PURE__*/ createController('ion-alert', Alert, [{ tagName: 'ion-backdrop', customElement: backdrop.Backdrop }]);
const actionSheetController = /*@__PURE__*/ createController('ion-action-sheet', ActionSheet, [{ tagName: 'ion-backdrop', customElement: backdrop.Backdrop }, { tagName: 'ion-ripple-effect', customElement: rippleEffect.RippleEffect }]);
const loadingController = /*@__PURE__*/ createController('ion-loading', Loading, [{ tagName: 'ion-backdrop', customElement: backdrop.Backdrop }, { tagName: 'ion-spinner', customElement: spinner.Spinner }]);
const modalController = /*@__PURE__*/ createController('ion-modal', Modal, [{ tagName: 'ion-backdrop', customElement: backdrop.Backdrop }]);
const pickerController = /*@__PURE__*/ createController('ion-picker', Picker, [{ tagName: 'ion-picker-column', customElement: PickerColumnCmp }, { tagName: 'ion-backdrop', customElement: backdrop.Backdrop }]);
const popoverController = /*@__PURE__*/ createController('ion-popover', Popover, [{ tagName: 'ion-backdrop', customElement: backdrop.Backdrop }]);
const toastController = /*@__PURE__*/ createController('ion-toast', Toast, [{ tagName: 'ion-ripple-effect', customElement: rippleEffect.RippleEffect }]);
